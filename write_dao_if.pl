...
my $directory = "D:\\eclipse_workspace\\CarFormat_Server\\src\\com\\ejycxtx";  # 目标文件夹
my $fileRegex = "OrderTrInfo";           # 目标文件
my $methodName = "deleteUser";    # 方法名
my $beanName = "Refuel";            # bean 有返回值时修改
my $paramType = "Map<String, String>";           # 参数类型
my $paramName = "map";                           # 参数名称
my $parameterClass = "map";                      # xml参数名称
my $methodNote = "删除订单出行人员信息";  # 方法注释
my $argNote = "线路ID、用户ID";
#方法类型 1:get rvo,2:insert,3:update,4:get list,5:get int,
my $method_type = "2";
my $insert_id = "INTERESTED_ID";           # 插入,count时的主键
my $tab_name = "T_F1_ORDER_TR_INFOR";   # 表名
...
sub get_mould{
    ...
    if ($method_type == "1" || $method_type == "4" || $method_type == "5") {
        $xml_ibatis = "select";
